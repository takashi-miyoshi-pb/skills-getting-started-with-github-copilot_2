...
activities = {
    ...
    "Swim Squad": {
        "description": "Practice strokes, endurance, and swim meets",
        "schedule": "Tuesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["nathan@mergington.edu", "isabella@mergington.edu"]
    },
    "Drama Club": {
        "description": "Explore acting, stagecraft, and perform plays",
    ...
    "Debate Team": {
        "description": "Practice public speaking and competing in debate tournaments",
